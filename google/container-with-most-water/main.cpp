...
{
    EXPECT_EQ(49, Solution{}.maxArea({1, 8, 6, 2, 5, 4, 8, 3, 7}));
    EXPECT_EQ(1, Solution{}.maxArea({1, 1}));
    EXPECT_EQ(16, Solution{}.maxArea({4, 3, 2, 1, 4}));
    EXPECT_EQ(2, Solution{}.maxArea({1, 2, 1}));
}
}  // namespace