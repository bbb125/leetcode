...
TEST(SolutionTests, All)
{
    ...
    EXPECT_EQ(
        ...
        Solution{}.minCostToSupplyWater(  // no-format
        60,
        {93151, 20876, 59743, 57253, 22852, 68389, 7424,  54743, 32955,
         39509, 14896, 54179, 51356, 78618, 95595, 69161, 37790, 67284,
         91644, 91111, 52096, 61039, 56597, 70549, 72491, 90473, 42299,
         76091, 89905, 31271, 58546, 48511, 72171, 78695, 41038, 81168,
         32922, 49332, 637,   7340,  70333, 20202, 45698, 64674, 12549,
         46263, 26798, 1334,  30355, 83189, 26439, 51031, 85145, 56095,
         38430, 79718, 82385, 25719, 97525, 82106},
         {std::vector{2, 1, 21154},   std::vector{3, 2, 81115},
          std::vector{4, 3, 94841},   std::vector{5, 2, 96414},
          std::vector{6, 3, 72515},   std::vector{7, 5, 52265},
          std::vector{8, 1, 60281},   std::vector{9, 5, 47008},
          std::vector{10, 6, 83062},  std::vector{11, 1, 83592},
          std::vector{12, 11, 29667}, std::vector{13, 5, 43482},
          std::vector{14, 8, 68029},  std::vector{15, 6, 29058},
          std::vector{16, 14, 14198}, std::vector{17, 8, 61513},
          std::vector{18, 10, 96383}, std::vector{19, 3, 12103},
          std::vector{21, 11, 51835}, std::vector{22, 8, 14803},
          std::vector{23, 22, 30324}, std::vector{24, 23, 63187},
          std::vector{25, 21, 62508}, std::vector{26, 13, 86421},
          std::vector{27, 22, 59810}, std::vector{28, 6, 80818},
          std::vector{29, 25, 350},   std::vector{30, 26, 9676},
          std::vector{31, 27, 11396}, std::vector{33, 29, 39112},
          std::vector{34, 18, 35099}, std::vector{35, 3, 79588},
          std::vector{36, 25, 93238}, std::vector{37, 30, 18366},
          std::vector{38, 16, 57918}, std::vector{39, 36, 14416},
          std::vector{40, 25, 27362}, std::vector{41, 5, 12434},
          std::vector{42, 9, 5570},   std::vector{43, 42, 72309},
          std::vector{44, 8, 81276},  std::vector{45, 44, 2620},
          std::vector{46, 44, 57766}, std::vector{47, 11, 71293},
          std::vector{48, 40, 14627}, std::vector{49, 48, 33901},
          std::vector{52, 49, 70471}, std::vector{53, 38, 6615},
          std::vector{55, 19, 77453}, std::vector{56, 9, 63999},
          std::vector{57, 34, 10940}, std::vector{58, 29, 43449},
          std::vector{59, 43, 22295}, std::vector{60, 5, 84242}}));
}
}  // unnamed namespace