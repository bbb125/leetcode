...
/**
 * url: https://leetcode.com/contest/weekly-contest-255/problems/find-greatest-common-divisor-of-array/
 * problem:
...
{
    EXPECT_EQ(2, Solution{}.findGCD({2, 5, 6, 9, 10}));
    EXPECT_EQ(1, Solution{}.findGCD({7, 5, 6, 8, 3}));
    EXPECT_EQ(3, Solution{}.findGCD({3, 3}));
}
}  // unnamed namespace